...
public class CircleArrayQueueDemo {
    public static void main(String[] args) {
        ...
        //创建一个队列
        CircleArray queue2 = new CircleArray(4);//设置为4，队列的最多有效数据为3
        char key; //接受用户的输入
...
class CircleArray {
    ...
    private int front; //指向队列的头部,这时候要指向第一个元素，包括第一个
    private int rear; //指向队列的尾部，指向最后一个后面的位置，不包括了
    ...
    public int headQueue() {
        ...
        return arr[front]; // 这里本身就指向队列的第一个元素了！
    }
}
